...
export class CoursesComponent implements OnInit {
  ...
  addCourse(ix) {
    ...
    this.grade_changed(0,control.length-1,4) ;
  }
  removeCourse(ix,iy) {
    const control = (<FormArray>this.mainForm.controls['years']).at(ix).get('courses') as FormArray;
    if(iy!=0){
...
university_changed(e){
  console.log(e) ;
if(e==2 ||e==4 || e==6 ||e==7 ||e==11 ||e==21 ||e==22 ||e==24 ||
  e==29 || e==30 ||e==33 || e==35 ||e==36 || e==39 || e==41 ||e==42 || e==44){
...
openDialog() {
  ...
  dialogRef.afterClosed().subscribe(result => {
    ...
    this.service.sendEmail(this.email_array).subscribe(data=>{
      console.log(data) ;
      this.openSnackBar("Email Sent") ;
    })
  });
}
grade_array=['A+','A','A-', 'B+','B','B-','C+','C','C-', 'D+','D','D-', 'E/F'];
...
grade_numeric_array3=['90–100',' 85–89','80–84', '77–79','73–76','70–72','67–69','63–66',
'60–62', '57–59','53–56','50–52', ' ≤ 49'];
grade_array_values=[];
grade_array_values_text=[4,3.90,3.70,3.30,3,2.70,2.30,2,1.70,1.30,1,0.70,0];
